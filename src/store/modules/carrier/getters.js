...
// 承运商司机信息
export const carrierDrivers = (state) => state.drivers.map((driver) => ({ name: driver.driverName, value: driver.driverName, id: driver.driverId, driverPhone: driver.driverPhone, carNO: driver.carNO }))
