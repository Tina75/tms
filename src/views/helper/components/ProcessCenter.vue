  ...
  data () {
    return {
      nodes: [
        ...
        /** 回单管理 */
        { x: '479px', y: '514px', type: 'huidanfanchang', poptip: '查看待司机送回回单的订单，可确认已收到回单', access: this.hasPower(110200), link: { path: TMSUrl.RECEIPT_ORDER_MANAGEMENT, query: { tab: 3 }, title: '回单管理' }, text: '回单返厂' },
