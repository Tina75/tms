  ...
  data () {
    return {
      nodes: [
        ...
        { x: '735px', y: '104px', type: 'zaitu', poptip: '查看在途的提货订单，确认是否提货成功', access: this.hasPower(120200), link: { path: TMSUrl.PICKUP_ORDER, query: { tab: 2 }, title: '提货管理' }, text: '在途' },
        { x: '870px', y: '104px', type: 'tihuochenggong', poptip: '提货成功，等待安排送货', access: this.hasPower(120200), link: { path: TMSUrl.PICKUP_ORDER, query: { tab: 3 }, title: '提货管理' }, text: '提货成功' },
        ...
        */
        ...
        /** 回单管理 */
        { x: '478px', y: '497px', type: 'huidanfanchang', poptip: '查看客户已经接收到回单的订单', access: this.hasPower(120500), link: { path: TMSUrl.RECEIPT_ORDER_MANAGEMENT, query: { tab: 4 }, title: '回单管理' }, text: '回单返厂' },
        { x: '603px', y: '497px', type: 'huidanjisong', poptip: '查看待客户接收回单的订单，可确认客户已经收到回单', access: this.hasPower(120500), link: { path: TMSUrl.RECEIPT_ORDER_MANAGEMENT, query: { tab: 3 }, title: '回单管理' }, text: '回单寄送' },
        { x: '735px', y: '497px', type: 'huidanhuishou', poptip: '查看待司机送回回单的订单，可确认已收到回单', access: this.hasPower(120500), link: { path: TMSUrl.RECEIPT_ORDER_MANAGEMENT, query: { tab: 2 }, title: '回单管理' }, text: '回单回收' }
      ]
    }
  }
}
