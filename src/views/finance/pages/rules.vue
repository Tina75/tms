    ...
    <div class="data-container">
      <div class="list-box">
        <Row type="flex">
          ...
          <div :style="{height: height + 'px'}" style="{'-ms-flex-direction: column;flex-direction: column;'}"
               class="left">
            ...
            <ul :style="{height: height -77  + 'px'}" class="ruleList">
              <li v-for="(item,index) in companyData" :class="{companyDataActive:companyDataActive === item.ruleId}"
                  :key="index" class="list" @click="showRuleDetail(item)">
                <div class="icon">
                      ...
                      <Row :gutter="24">
                        ...
                        <div v-if="ruleDetail.ruleType!=='5'&&ruleDetail.ruleType!=='8'" class="startPrice">
                          ...
                          <FormItem prop="startNum" inline style="margin-bottom: 0;">
                            ...
                            <TagNumberInput v-model="item.startNum" :show-chinese="false" :precision="precision"
                                            style="width: 80px" @on-change="setItemStartNum(item)"></TagNumberInput>
                          </FormItem>
                          ...
                          <div v-if="item.startType === '1'" style="display: inline-block">
                            <FormItem prop="startPrice" inline style="margin-bottom: 0;">
                              ...
                              <TagNumberInput v-model="item.startPrice" :show-chinese="false"
                                              style="width: 80px"></TagNumberInput>
                            </FormItem>
                            <span>元起</span>
                          </div>
                          <!--起送量 startType 2-->
                          <div v-if="item.startType === '2'" style="display: inline-block">按<span
                            style="padding: 0 10px">{{item.startNum}}</span>{{unitMap[ruleDetail.ruleType]}}计算
                          </div>
                        </div>
                        </Col>
                    ...
                    <div slot="content">
                      <ul class="rule-detail">
                        <li v-for="(el, no) in item.chargeRules" :key="no" class="rule-detail-item">
                          ...
                          <!--&lt;!&ndash;<Input v-model="el.price" />&ndash;&gt;-->
