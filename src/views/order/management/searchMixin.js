...
export default {
  ...
  methods: {
    ...
    handleTimeChange (val) {
      this.keywords.createTimeStart = val[0] + ' 00:00:00'
      this.keywords.createTimeEnd = val[1] + ' 23:59:59'
      this.searchList()
    },
    // 修改回收开始结束时间
    handleRecoveryTimeChange (val) {
      this.keywords.recoveryTimeStart = val[0] + ' 00:00:00'
      this.keywords.recoveryTimeEnd = val[1] + ' 23:59:59'
      this.searchList()
    },
    // 修改返厂开始结束时间
    handleReturnTimeChange (val) {
      this.keywords.returnTimeStart = val[0] + ' 00:00:00'
      this.keywords.returnTimeEnd = val[1] + ' 23:59:59'
      this.searchList()
    },
    // 筛选列表显示字段
